...
function theme_setup() {
	...
	*  sizes with add_image_size. */
	...
	add_image_size('square', 450, 300, true);
	add_image_size('hero', 2742, 1434, true);
	add_image_size('hero-small', 2742, 1000, true);
	add_image_size('logo', 360, 134, false);
	add_image_size('large-square', 450, 300, true);
	add_image_size('about', 300, 300, true);
	add_image_size('activities', 700, 700, true);
	add_image_size('activities-page', 970, 750, true);
	add_image_size('teachers', 800, 800, true);
	add_image_size('gallery', 800, 800, true);


	// add new image size option to media image library
...
function hackeryou_scripts() {
  ...
  wp_enqueue_script(
  	'jquery',
    get_template_directory_uri() . '/js/jquery.min.js', //source
  	false, //dependencies
  	null, //version number
  	true //load in footer
  );
  ...
  wp_enqueue_style( 'animate', get_stylesheet_directory_uri() . '/js/animate.css', array(), '1.5.9' );

  // magnific-popup
  wp_enqueue_script( 'magnific-popup-js-js', get_template_directory_uri() . "/js/magnific-popup/jquery.magnific-popup.js", array( 'jquery' ), '1.5.9', true );
  
  wp_enqueue_style( 'magnific-popup-js-style', get_stylesheet_directory_uri() . '/js/magnific-popup/magnific-popup.css', array(), '1.5.9' );
   

  // scroll reveal
  wp_enqueue_script( 'scrollreveal-js-js', get_template_directory_uri() . "/js/scrollreveal/scrollreveal.min.js", array( 'jquery' ), '1.5.9', true );
 
 // flickity

  wp_enqueue_script( 'flickity-js-js', get_template_directory_uri() . "/js/flickity/flickity.pkgd.min.js", array( 'jquery' ), '1.5.9', true );
  wp_enqueue_script( 'flickity-js-js', get_template_directory_uri() . "/js/flickity/as-nav-for.js", array( 'jquery' ), '1.5.9', true );
  wp_enqueue_style( 'flickity-js-style', get_stylesheet_directory_uri() . '/js/flickity/flickity.min.css', array(), '1.5.9' );
